...
opening_result = perform_morphological_operations(binary_image, 'opening', kernel_size=3)
...
closing_result = perform_morphological_operations(binary_image, 'closing', kernel_size=3)
